...
class Empleado:
    ...
    """
    #atributo de clase. Lo dejamos como privado en esta ocasión
    __aumento_general = 1.05 #5% de aumento para todos (Para todas las instancias)
    ...
    def cambiar_aumento_general(cls, nuevo_factor):
        if  nuevo_factor<=1:
            print("+El aumento debe ser mayor a 0. Ej: 1.05, 1.10")
    ...
    def aplicar_aumento(self):
        self.salario = self.salario*Empleado.__aumento_general

    def get_aumento_general(cls):
        return cls.__aumento_general


empleado1 = Empleado("Luis", 1500000)
empleado2 = Empleado("Ana", 1800000)
empleado3 = Empleado("Sofía", 1800000)

print ("="*10," Empleados iniciales ", "="*10)

empleado1.mostrar_info_empleado()
empleado2.mostrar_info_empleado()
empleado3.mostrar_info_empleado()

print ("="*10," Evaluar salario vs umbral ", "="*10)
umbral = 1250000
empleados = [empleado1, empleado2, empleado3]

for empleado in empleados:
    es_alto = Empleado.supera_umbral(empleado.salario, umbral)
...
print ("="*10," Cambiar aumento general desde la clase ", "="*10)
...
print("="*10," Aumento de salario ", "="*10)
for empleado in empleados:
    empleado.aplicar_aumento()

print("="*10," Empleados luego del aumento de salario", "="*10)
empleado1.mostrar_info_empleado()
empleado2.mostrar_info_empleado()
empleado3.mostrar_info_empleado()
...
VALUES 
('Condimentos', 'Salsas dulces y saladas, condimentos'),
('Confites', 'Postres, dulces y pan dulce'),
('Lácteos', 'Quesos'),
('Granos/Cereales', 'Panes, galletas, pastas y cereales'),
('Carne/Aves', 'Carnes preparadas'),
('Frutas y verduras', 'Frutas secas y cuajada de soja'),
('Mariscos', 'Algas y pescado');


INSERT INTO clientes (nombre_cliente, nombre_contacto, direccion, ciudad, codigo_postal, pais)
VALUES
